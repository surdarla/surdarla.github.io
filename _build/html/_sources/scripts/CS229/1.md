...
:::{admonition} Machine learning Definition by Arthur Samuel 1959:class warning

Field of study that gives computers the ability to learn without being explicitly programmed
:::

Arthur Samuel의 정의는 오래된 것이고, Andrew Ng의 친구인 Tom Mitchell의 정의가 좀 더 구체적이다.
:::{admonition} Tom Mitchell 1998  well-posed learning problem :class warning
...
## Machine learning strategy 머신러닝 전략
